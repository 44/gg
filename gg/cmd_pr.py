...
def _get_manage_lua(pr_id, manage_path, cache_dir):
    return (
        ...
        "  local _, reviewers_lnum, _, threads_lnum, changes_lnum, policies_lnum = find_section_boundaries()\n"
        "  local targets = {{\n"
        "    reviewers = reviewers_lnum,\n"
        "    threads = threads_lnum,\n"
        "    changes = changes_lnum,\n"
        "    policies = policies_lnum,\n"
        "  }}\n"
        "  local lnum = targets[section]\n"
        "  if lnum then\n"
        ...
        "  callback = function() goto_section('reviewers') end,\n"
        "  noremap = true,\n"
        "  silent = true,\n"
        "}})\n"
        "\n"
        "vim.api.nvim_buf_set_keymap(0, 'n', 'gt', '', {{\n"
        "  callback = function() goto_section('threads') end,\n"
        "  noremap = true,\n"
        "  silent = true,\n"
        "}})\n"
        "\n"
        "vim.api.nvim_buf_set_keymap(0, 'n', 'gc', '', {{\n"
        "  callback = function() goto_section('changes') end,\n"
        "  noremap = true,\n"
        "  silent = true,\n"
        "}})\n"
        "\n"
        "vim.api.nvim_buf_set_keymap(0, 'n', 'gp', '', {{\n"
        "  callback = function() goto_section('policies') end,\n"
        "  noremap = true,\n"
        "  silent = true,\n"
        "}})\n"
        "\n"
